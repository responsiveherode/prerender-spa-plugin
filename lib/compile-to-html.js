      ...
      Server.register(Inert, function (error) {
        ...
        Server.start(function (error) {
          ...
          if (options.phantomOptions) {
            if (!options.phantomOptions.concat) {
              options.phantomOptions = [options.phantomOptions];
            }

            phantomArguments = options.phantomOptions.concat(phantomArguments);
          }
